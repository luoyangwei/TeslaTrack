...
type Server struct {
	...
	Tesla *Server_Tesla `protobuf:"bytes,4,opt,name=tesla,proto3" json:"tesla,omitempty"`
}
...
func (x *Server) GetTesla() *Server_Tesla {
	if x != nil {
		return x.Tesla
	}
	return nil
...
func (x *Server_Tesla) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Tesla) ProtoMessage() {}

func (x *Server_Tesla) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Tesla.ProtoReflect.Descriptor instead.
func (*Server_Tesla) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 3}
}

func (x *Server_Tesla) GetCallback() string {
	if x != nil {
		return x.Callback
	}
	return ""
...
func (x *Server_Tesla) GetRedirectUrl() string {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xe1, 0x04, 0x0a,
	...
	0x65, 0x72, 0x2e, 0x4d, 0x75, 0x78, 0x52, 0x03, 0x6d, 0x75, 0x78, 0x12, 0x2e, 0x0a, 0x05, 0x74,
	0x65, 0x73, 0x6c, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x54,
	0x65, 0x73, 0x6c, 0x61, 0x52, 0x05, 0x74, 0x65, 0x73, 0x6c, 0x61, 0x1a, 0x85, 0x01, 0x0a, 0x04,
	0x48, 0x54, 0x54, 0x50, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x64, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x33,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x68,
	0x0a, 0x03, 0x4d, 0x75, 0x78, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x46, 0x0a, 0x05, 0x54, 0x65, 0x73, 0x6c,
	0x61, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x21, 0x0a,
	...
	0x42, 0x1f, 0x5a, 0x1d, 0x74, 0x65, 0x73, 0x6c, 0x61, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x2f, 0x69,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Mux)(nil),          // 5: kratos.api.Server.Mux
	(*Server_Tesla)(nil),        // 6: kratos.api.Server.Tesla
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.mux:type_name -> kratos.api.Server.Mux
	6,  // 5: kratos.api.Server.tesla:type_name -> kratos.api.Server.Tesla
	...
	9,  // 10: kratos.api.Server.Mux.timeout:type_name -> google.protobuf.Duration
