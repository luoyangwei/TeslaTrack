...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\xcc\x03\n" +
	"\x06Server\x12+\n" +
	"\x04http\x18\x01 \x01(\v2\x17.kratos.api.Server.HTTPR\x04http\x12+\n" +
	"\x04grpc\x18\x02 \x01(\v2\x17.kratos.api.Server.GRPCR\x04grpc\x12(\n" +
	"\x03mux\x18\x03 \x01(\v2\x16.kratos.api.Server.MuxR\x03mux\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 9: kratos.api.Server.Mux.timeout:type_name -> google.protobuf.Duration
